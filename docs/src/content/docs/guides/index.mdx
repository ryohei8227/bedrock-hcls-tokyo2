...
title: Quickstart
---
Welcome to the Sample agents for Healthcare & Life Sciences  contribution guide. This step-by-step tutorial will help you create your own domain-specific agent and contribute it to our growing catalog, as well as configure multiple agents to collaborate effectively.
...
2. Wait for the stack deployment to complete (~5-10 minutes)
3. Access your agent through the AWS Bedrock console
...
- Review Bedrock documentation to use multi-agent collaboration
...
Congratulations! You've learned how to:
    ...
    - Create a specialized agent for healthcare and life sciences
    - Contribute your agent to the community catalog
    - Configure multiple agents to collaborate on complex queries

By following this guide, you've added valuable capabilities to the Sample agents for Healthcare & Life Sciences on AWS ecosystem. Your contribution will help healthcare and life sciences organizations leverage AI to improve patient care, streamline operations, and accelerate research.

### Next Steps

    Explore advanced agent customization options in the Amazon Bedrock [documentation](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-bedrock.html)
